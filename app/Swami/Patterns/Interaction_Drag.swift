...
public struct Interaction_DragView: View {
    ...
    /// Non-visual geometry recovered from the placed graph. It constrains Drag's
    /// state and never creates a frame, shape, or layer in the rendered hierarchy.
    enum DragGeometry {
...
private final class InteractionDragBundleMarker: NSObject {}
